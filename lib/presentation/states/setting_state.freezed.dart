...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime dateTime, ThemeMode themeMode});
}
...
class _$_SettingState extends _SettingState {
  _$_SettingState({required this.dateTime, required this.themeMode})
      : super._();
  ...
  @override
  String toString() {
    return 'SettingState(dateTime: $dateTime, themeMode: $themeMode)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, dateTime, themeMode);
...
abstract class _SettingState extends SettingState {
  factory _SettingState(
      ...
      required final ThemeMode themeMode}) = _$_SettingState;
