...
class ChoiceParamsGameCubit extends Cubit<ChoiceParamsGameState> {
  ...
  void setCategory({required CategoryModel? categoryModel}) {
    print("pp");
    gameRepositoryImpl.setCategoryQuestion(category_question: categoryModel);
    emit(
      ChoiceParamsGameStateLoaded(
        params: ParamsGameEntity(
          difficulty_question: state.params!.difficulty_question,
