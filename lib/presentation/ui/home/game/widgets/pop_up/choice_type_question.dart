    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          ChoiceChipModal(
            isSelected:
                (typeQuestionChoose == TYPE_QUESTION.any) ? true : false,
          ...
          ChoiceChipModal(
            isSelected:
                (typeQuestionChoose == TYPE_QUESTION.multiple) ? true : false,
          ...
          ChoiceChipModal(
            ...
            isSelected:
                (typeQuestionChoose == TYPE_QUESTION.boolean) ? true : false,
