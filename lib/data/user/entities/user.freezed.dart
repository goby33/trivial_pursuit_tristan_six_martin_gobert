...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, surname: $surname, email: $email, pseudo: $pseudo, password: $password, score: $score)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, surname, email, pseudo, password, score);
